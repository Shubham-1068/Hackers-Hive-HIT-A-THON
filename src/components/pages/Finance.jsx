...
export default function Finance() {
  ...
  const randomBusinesses = filteredBusinesses.sort(() => Math.random() - 0.5).slice(0, 8)
  return (
    <div className="flex h-screen w-screen absolute top-[70px]">
      <div className="bg-[#f5f5f5] p-8 w-[25%] h-full max-w-xs border-r fixed left-0 top-[70px]">
