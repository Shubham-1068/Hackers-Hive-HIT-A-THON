...
export default function Finance() {
  ...
  const businesses = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1456655010498-adf10969b75f?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      website: "#",
    },
    {
      name: "Tidy Cleaners",
      ...
      <div className="flex h-screen w-screen absolute top-[70px]">
        ...
        <div className="w-screen md:w-[78%] flex-1 py-10 absolute right-0 top-[540px] md:top-0">
          <div className="container px-4 md:px-6 w-full">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 m-auto h-[3500px] w-[90%] md:h-[900px]">
